...
{
    /**
     * Calls all the methods listed in the Sorted Word List Class
     * 
     * @param args
     *            no argument
     */
    public static void main( String[] args )
    {
        ...
        System.out
            .println( "contains(\"Aaron\") = " + names1.contains( "Aaron" )
                + " indexOf(\"Aaron\") = " + names1.indexOf( "Aaron" ) );
        ...
        names1.merge( names3 );
        System.out.println( names1 );
//        System.out.println(names1.contains( "gina" ));
    }
}
/*
