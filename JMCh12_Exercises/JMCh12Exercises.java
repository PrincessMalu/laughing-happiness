...
public class JMCh12Exercises
{
    ...
    public char getRandomRps()
    {
        ...
        char[] random = { 'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's', 's',
            's', 's', 's', 's' };
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount
            + "the number of zeros that come before the first nonzero number";
    ...
    {
        ArrayList<String> order = new ArrayList<String>( list.size() );
        for ( int k = 0; k < list.size(); k++ )
        {
            order.add( 0, list.get( k ) );
        }
    ...
    public void removeMin( ArrayList<Integer> list )
    {
        if ( !list.isEmpty() )
        {
            ...
            {
                int compare = smallest.compareTo( list.get( i ) );
                if ( compare > 0 )
                {
                    remove = i;
                    smallest = list.get( i );
