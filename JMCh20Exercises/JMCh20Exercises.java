...
public class JMCh20Exercises<E>
{
    ...
    {
        ListNode<E> newValue = new ListNode<E>( value, null );
        if ( head == null )
        {
            head = newValue;
            return head;
    ...
    {
        ListNode<E> newList = null;

        for ( ListNode<E> temp = head; temp != null; temp = temp.getNext() )
        {
            ListNode<E> nNode = new ListNode<E>( temp.getValue(), newList );
            newList = nNode;
        }
    ...
    {
        ListNode<String> temp = null;
        ListNode<String> end = null;
        String sum = "";

        for (ListNode<String> temp2 = head; temp2 != null; temp2 = temp2.getNext())
        {
          sum += temp2.getValue();
          ListNode<String> newValue = new ListNode<String>(sum, null);
          if (end == null)
            temp = newValue;
          else
    ...
    public ListNode<E> rotate( ListNode<E> head )
    {
        ...
        return newHead; // TODO fix return value
    }
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        ListNode<String> newValue = new ListNode<String>( s, null );
        ...
        if ( temp != null && s.equalsIgnoreCase( temp.getValue() ) )
            return head;
    ...
    {
        ListNode<String> first = head;

        while (first != null)
        {
          ListNode<String> minN = first;
          for (ListNode<String> node = first.getNext(); node != null; node = node.getNext())
          {
            String str = (String)node.getValue();
            if (str.compareTo((String)minN.getValue()) < 0)
              minN = node;
          }
          Object min = minN.getValue();
          minN.setValue(first.getValue());
          first.setValue((String)min);
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        ...
        for ( ListNode2<Integer> temp = head; temp != null; temp = temp
            .getNext() )
        {
